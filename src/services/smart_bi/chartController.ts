...
/** generateChartByAI POST /api/chart/generate */
export async function generateChartByAIUsingPOST(
  ...
  return request<API.BaseResponseAiResponse_>('/api/chart/generate', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** generateChartByAIAsync POST /api/chart/generate/async */
export async function generateChartByAIAsyncUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.generateChartByAIAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseAiResponse_>('/api/chart/generate/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** generateChartByAIAsyncMq POST /api/chart/generate/async/mq */
export async function generateChartByAIAsyncMqUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.generateChartByAIAsyncMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseAiResponse_>('/api/chart/generate/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
