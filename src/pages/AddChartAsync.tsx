import { generateChartByAIAsyncUsingPOST } from '@/services/smart_bi/chartController';
...
const AddChartAsync: React.FC = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      const res = await generateChartByAIAsyncUsingPOST(params, {}, values.file.file.originFileObj);
      console.log(res);
      if (!res?.data) {
        message.error('提交失败');
      } else {
